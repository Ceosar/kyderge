...
Start: jmp InitProc      ; переход на инициализацию
    ...
    Y_make:
        ...
        je  Y_make          ; то ожидать нажатия M

        cmp AL,32h          ; если нажата M
        je  Y_break         ; то на проверку отпускания
                

        jmp V_make          ; иначе начинаем заново
    Y_break:
        in  AL, 60h         ; в AL - скан код клавиши
        cmp AL, 0B2h        ;┐если не код отпускания M
        jne Y_break         ;┘то ожидать отпускания клавиши
